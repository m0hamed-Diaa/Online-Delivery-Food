...
//             })
//             addToCart(productId);
//             document.querySelector("#cart_tab").classList.add("active");
//             document.querySelector(".close_cart").onclick = function () {
//                 document.querySelector("#cart_tab").classList.remove("active");
//             }
//         })
//     })
// })
...
//     document.querySelector(".count_items_in_cart").innerHTML = totalCount;
//     document.querySelector(".cart_info_count_header").innerHTML = totalCount;
//     document.querySelector(".sum_of_quaintity").innerHTML = `$${total_price}`;
//     if (allProductsCheckout) {
//         allProductsCheckout.innerHTML = checkoutHTML;
//         document.querySelector(".cart_info_count_header").innerHTML = totalCount;
//         document.querySelector(".count_items_in_cart").innerHTML = totalCount;
//         document.querySelector(".sum_of_quaintity_checkout").innerHTML = `$${total_price}`
//     }

//     allProductsInCart.onclick = e => {
...
// }
// function updateButtonsState (prouctId) {
//     const btnMatchingButtons = document.querySelectorAll(`.add_to_cart[data-id="${prouctId}"]`);
//     btnMatchingButtons.forEach((btn) => {
